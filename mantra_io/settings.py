...
ENCRYPTION_KEY = os.environ.get('ENCRYPTION_KEY', 'oRVCHTumzesh-E71A-bAnjjEDuIlkceL6dvAYimantra_iop0=')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            # 'filename': os.path.join(BASE_DIR, 'D:/Python Project/mantra_io logs', 'django.log'),  
...
WSGI_APPLICATION = 'mantra_io.wsgi.application'
